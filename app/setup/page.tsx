    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      <div className="w-full max-w-lg">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-slate-900">Postavite vaš salon</h1>
          <p className="text-sm text-slate-500 mt-1">
            Unesite osnovne podatke o salonu da biste nastavili
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6">
          ...
          <p className="text-xs text-slate-500 mb-6">Korak 1 od 3 — Podaci o salonu</p>
          ...
          <form action={action} className="space-y-4">
            ...
            >
              {pending ? "Kreiranje salona..." : "Nastavi →"}
            </button>
          </form>
        </div>

        <div className="text-center text-sm text-slate-500 mt-4">
          Želite li koristiti drugi račun?{" "}
